...
const MENU = [
  ...
  { id: "m5", section: "menu", category: "Plats Africains", name: "Attiéké poisson", description: "Semoule de manioc, poisson grillé, sauce tomate", price: 3e3, image: img("photo-1606851094291-6efae152bb87") },
  // Européens
  ...
  { id: "m10", section: "menu", category: "Entrées", name: "Bruschetta tomate", description: "Pain grillé, tomates fraîches, basilic", price: 2e3, image: img("photo-1572441713132-c542fc4fe282") },
  { id: "m11", section: "menu", category: "Desserts", name: "Mousse au chocolat", description: "Chocolat noir, crème fouettée", price: 2e3, image: img("photo-1541783245831-57d6fb0926d3") },
...
const PIZZAS = [
  ...
  { id: "p5", section: "pizza", category: "Spéciales", name: "Spéciale Le Tablier", description: "Recette maison secrète", price: 5e3, image: img("photo-1513104890138-7c749659a591") },
...
const DRINKS = [
  ...
  { id: "d3", section: "bar", category: "Jus frais", name: "Bissap Frais", description: "Hibiscus, citron, menthe, sucre de canne", price: 1e3, image: img("photo-1546171753-97d7676e4602") },
  ...
  { id: "d5", section: "bar", category: "Bières", name: "Bière Flag", description: "Bière locale togolaise", price: 1e3, image: img("photo-1608270586620-248524c67de9") },
  ...
  { id: "d9", section: "bar", category: "Vins", name: "Vin rouge — Bouteille", description: "Sélection maison", price: 8e3, image: img("photo-1553361371-9b22f78e8b1d") },
